...
Collection.connection.execute('ALTER SEQUENCE collections_id_seq RESTART WITH 1')
puts 'Creating Collections'
Collection.create!(user_id: 1, name: "My Art")
Collection.create!(user_id: 1, name: "Shared Art")
Collection.create!(user_id: 2, name: "My Art")
Collection.create!(user_id: 2, name: "Shared Art")
Collection.create!(user_id: 3, name: "My Art")
Collection.create!(user_id: 3, name: "Shared Art")
Collection.create!(user_id: 4, name: "My Art")
Collection.create!(user_id: 4, name: "Shared Art")


ArtworkCollection.destroy_all
ArtworkCollection.connection.execute('ALTER SEQUENCE artwork_collections_id_seq RESTART WITH 1')
puts 'Creating Artwork Collections'
ArtworkCollection.create!(collection_id: 1, artwork_id: 1)
ArtworkCollection.create!(collection_id: 1, artwork_id: 8)
ArtworkCollection.create!(collection_id: 2, artwork_id: 4)
ArtworkCollection.create!(collection_id: 2, artwork_id: 5)
ArtworkCollection.create!(collection_id: 3, artwork_id: 2)
ArtworkCollection.create!(collection_id: 3, artwork_id: 5)
ArtworkCollection.create!(collection_id: 3, artwork_id: 6)
ArtworkCollection.create!(collection_id: 3, artwork_id: 7)
ArtworkCollection.create!(collection_id: 3, artwork_id: 9)
ArtworkCollection.create!(collection_id: 4, artwork_id: 3)
ArtworkCollection.create!(collection_id: 4, artwork_id: 10)
ArtworkCollection.create!(collection_id: 5, artwork_id: 3)
ArtworkCollection.create!(collection_id: 6, artwork_id: 5)
ArtworkCollection.create!(collection_id: 6, artwork_id: 6)
ArtworkCollection.create!(collection_id: 6, artwork_id: 1)
ArtworkCollection.create!(collection_id: 6, artwork_id: 2)
ArtworkCollection.create!(collection_id: 6, artwork_id: 4)
ArtworkCollection.create!(collection_id: 6, artwork_id: 7)
ArtworkCollection.create!(collection_id: 6, artwork_id: 8)
ArtworkCollection.create!(collection_id: 6, artwork_id: 9)
ArtworkCollection.create!(collection_id: 6, artwork_id: 10)
ArtworkCollection.create!(collection_id: 7, artwork_id: 4)
ArtworkCollection.create!(collection_id: 7, artwork_id: 10)
ArtworkCollection.create!(collection_id: 8, artwork_id: 1)
ArtworkCollection.create!(collection_id: 8, artwork_id: 2)
ArtworkCollection.create!(collection_id: 8, artwork_id: 3)
ArtworkCollection.create!(collection_id: 8, artwork_id: 7)
ArtworkCollection.create!(collection_id: 8, artwork_id: 8)
ArtworkCollection.create!(collection_id: 8, artwork_id: 9)
ArtworkCollection.create!(collection_id: 8, artwork_id: 5)
ArtworkCollection.create!(collection_id: 8, artwork_id: 6)