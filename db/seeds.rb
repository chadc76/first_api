...
Comment.create!(author_id: u4.id, artwork_id: a1.id, body: "Cool Art Bro")
Comment.create!(author_id: u4.id, artwork_id: a2.id, body: "Cool Art Man")
Comment.create!(author_id: u2.id, artwork_id: a3.id, body: "Cool Art Dude")
Comment.create!(author_id: u4.id, artwork_id: a3.id, body: "Cool Art My Guy")
Comment.create!(author_id: u1.id, artwork_id: a4.id, body: "Cool Art My Dude")
Comment.create!(author_id: u1.id, artwork_id: a5.id, body: "Cool Art My Man")
Comment.create!(author_id: u3.id, artwork_id: a5.id, body: "Cool Art Broski")
Comment.create!(author_id: u3.id, artwork_id: a6.id, body: "Cool Art Homie")
Comment.create!(author_id: u4.id, artwork_id: a7.id, body: "Cool Art Brotha")
Comment.create!(author_id: u4.id, artwork_id: a8.id, body: "Cool Art Fam")
Comment.create!(author_id: u4.id, artwork_id: a9.id, body: "Cool Art Buddy")
Comment.create!(author_id: u2.id, artwork_id: a10.id, body: "Cool Art Pal")