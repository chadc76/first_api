...
Like.create!(user_id: 3, likeable_id: 7, likeable_type: "Comment")
Like.create!(user_id: 4, likeable_id: 8, likeable_type: "Artwork")
Like.create!(user_id: 3, likeable_id: 8, likeable_type: "Comment")
Like.create!(user_id: 4, likeable_id: 9, likeable_type: "Artwork")
Like.create!(user_id: 3, likeable_id: 9, likeable_type: "Comment")
Like.create!(user_id: 4, likeable_id: 10, likeable_type: "Artwork")
